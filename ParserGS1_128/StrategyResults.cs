...
namespace ParserGS1
{
    ...
    {
        public StrategyResults() { PrecedenceLevel = KeysAI.Length; }
       
        /// <summary> Набор обязательных полей в объекте  </summary>
        ...
        public virtual object CompletingFields(string fullStrings, string[] codeStrings, Dictionary<string, RuleKeyAI> RuleKeys) { return null; }
